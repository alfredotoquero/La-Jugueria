...
if(mysql_result(mysql_query("select cantidad from trcuentaproductostmp where idtmp = '$idproducto'"),0)>1){
	mysql_query("update trcuentaproductostmp set cantidad = cantidad - 1 where idtmp = '$idproducto'");
}else{
	mysql_query("delete from trcuentaproductostmp where idtmp = '$idproducto'");
}
?>